  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-brown-light mt-3">
          We'd love to hear from you — questions, feedback, or just to say
          hello.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-[1fr_1.2fr] gap-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <InfoCard
            icon={FiMail}
            title="Email Us"
            lines={["care@houseofjaee.com"]}
          />

          <a
            href="https://wa.me/7822876646"
            target="_blank"
  ...
  return (
    <div className="bg-white border border-beige-dark rounded-sm p-5 flex gap-4">
      ...
      <div>
        ...
        {lines.map((line) => (
          <p key={line} className="text-sm text-brown-light">
            {line}
          </p>
        ))}
      </div>
